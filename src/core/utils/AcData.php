...
// list of const values we need
final class AcData
{
  public const LAST_CLICK_TIME = 0;
  public const MSECS_OFF = 1;
  public const TIMER_FLAGS_COUNT = 2;
  public const LAST_PLAYER_AUTH_TIME = 3;
